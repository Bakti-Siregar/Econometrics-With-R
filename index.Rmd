...
biblatexoptions:
  - sortcites
link-citations: yes
github-repo: "https://github.com/Bakti-Siregar/Econometrics-With-R"
description: "Beginners with little background in statistics and econometrics often have a hard time understanding the benefits of having programming skills for learning and applying Econometrics. 'Econometrics with R' is an interactive companion to the well-received textbook 'Introduction to Econometrics' by Bakti Siregar, M.Sc. It gives a gentle introduction to the essentials of R programming and guides students in implementing the empirical applications presented throughout the textbook using the newly aquired skills. This is supported by interactive programming exercises generated with DataCamp Light and integration of interactive visualizations of central concepts which are based on the flexible JavaScript library D3.js."
...
<center><img src='https://github.com/Bakti-Siregar/Econometrics-With-R/raw/master/images/cover.png' style = 'width:60%;'></center>

<br> Lecture of Statistics <img style='float: right; margin: 0px 100px 0px 0px; width:35%' src='https://github.com/Bakti-Siregar/Econometrics-With-R/raw/master/images/logomatana.png'/> <br> Faculty of STEM <br> [Matana University](https://matanauniversity.ac.id/?ly=academic&c=sb) <br> Tangerang, Banten <br> <a href="http://matanauniversity.ac.id/?ly=academic&c=sb">Info: siregarbakti@gmail.com</a> <br><br> `r sf <- lubridate::stamp_date('Last updated on Saturday, Februay 1, 2020'); sf(Sys.Date())`
<br>
<br>
<iframe src="https://www.facebook.com/siregarbakti" width="400" height="70" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media" align="left"></iframe>
<br>
<br>
<br>
...
I would like to express my deepest appreciation to all those who provided me the possibility to complete this book.  A special gratitude I give to My Angel, Ericha Enggelina, whose contribution in stimulating suggestions and encouragement,  helped me to coordinate my project especially in writing this book.

Furthermore I would also like to acknowledge with much appreciation the crucial role Mr F. Anthon Pangruruk, who gave the permission to use all required  equipment and the necessary materiasl to complete the  task “Econometrics With R”. A special thanks goes to my team mate, Mr. Simon Petrus Barus, who  help me to assemble the parts and gave suggestion. 
...
knitr::include_graphics('https://github.com/Bakti-Siregar/Econometrics-With-R/raw/master/images/rstudio.jpg')
```
