...
<br> Lecture of Statistics <img style='float: right; margin: 0px 100px 0px 0px; width:35%' src='images/logomatana.png'/> <br> Faculty of STEM <br> [Matana University](https://matanauniversity.ac.id/?ly=academic&c=sb) <br> Tangerang, Banten <br> <a href="http://matanauniversity.ac.id/?ly=academic&c=sb">Info: siregarbakti@gmail.com</a> <br><br> `r sf <- lubridate::stamp_date('Last updated on Saturday, Februay 1, 2020'); sf(Sys.Date())`
<br>
<br>
